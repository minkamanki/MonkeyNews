...
MonkeyNewsin juuresta aukee valikko josta voi joko siirtyä selaamaan artikkeleita [Browse news](http://monkeynews.herokuapp.com/home) tai siirtyä hallintapaneeliin [Edit panel](http://monkeynews.herokuapp.com/articles/).<br />
...
Artikkelit listaantuvat samalla sivulla olevaan "Current Articles" kohtaan. Tässä myös nähdään siihen liitetyt kirjoittajat ja kategoriat. Artikkelin voi tästä poistaa napista "Remove article" ja sitä voi ediotoita napista "Edit article".<br />
...
Lisäsi pohjalla on "Edit article" linkki, josta voi editoida mitä tahansa aiemmin syötettyjä atribuutteja.<br />
...
[Home](http://monkeynews.herokuapp.com/home), [Newest](http://monkeynews.herokuapp.com/home/newest), [Most read this week!](http://monkeynews.herokuapp.com/home/mostRead), [Edit panel](http://monkeynews.herokuapp.com/articles) ja [Log in](http://monkeynews.herokuapp.com/login).<br />

Edit panel linkistä pääsee hallintapaneeliin, ja Log in vie taas sisäänkirjautumiseen.<br />
